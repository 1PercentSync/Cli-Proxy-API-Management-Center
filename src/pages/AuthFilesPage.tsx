...
export function AuthFilesPage() {
  ...
  const handleHeaderRefresh = useCallback(async () => {
    await Promise.all([loadFiles(), loadKeyStats(), loadExcluded(), loadModelMappings(), loadAuthPriority()]);
  }, [loadFiles, loadKeyStats, loadExcluded, loadModelMappings, loadAuthPriority]);
